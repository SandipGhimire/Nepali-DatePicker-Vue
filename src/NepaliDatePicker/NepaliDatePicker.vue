          ...
          <div class="calendar__body">
            ...
            <div class="calendar__head">
              ...
              <div class="calendar__header_label">
                ...
                <a class="calendar__header_selector" @click.stop="toggleYear" v-if="!showYear && yearSelect">
                  {{ date.format("YYYY") }}
                </a>
                ...
                <div class="calendar__days">
                  <template v-if="calendarDays.prevRemainingDays > 0">
                    <div
                      ...
                      :class="{
                        calendar__disable_date: isDateDisabled(getFullDate(calendarDays.prevMonth, day)),
                        calendar__not_current_month_saturday:
                          isSaturday(getFullDate(calendarDays.prevMonth, day)) && highlightSaturday,
                      }"
                  ...
                  <div
                    ...
                    :class="{
                      ...
                      calendar__disable_date: isDateDisabled(getFullDate(calendarDays.currentMonth, day)),
                      calendar__saturday: isSaturday(getFullDate(calendarDays.currentMonth, day)) && highlightSaturday,
                    }"
                  ...
                  <template v-if="calendarDays.remainingDays > 0">
                    <div
                      ...
                      :class="{
                        calendar__disable_date: isDateDisabled(getFullDate(calendarDays.nextMonth, day)),
                        calendar__not_current_month_saturday:
                          isSaturday(getFullDate(calendarDays.nextMonth, day)) && highlightSaturday,
                      }"
...
const handleInput = (e: any) => {
  ...
  if (/^\d{4}$/.test(year)) {
    ...
    try {
      if ((IminDate.value && tempYear < IminDate.value.year) || (ImaxDate.value && tempYear > ImaxDate.value.year)) {
